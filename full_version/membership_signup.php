				...
				<div class="card-content" style="margin-top:30px">
					<form method="post" action="membership_signup.php" >		
						<div class="form-group label-floating">
							...
							<input class="form-control" type="text" required="" id="username" name="newUsername">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group label-floating" style="margin:20px 0">
							...
							<div class="col-sm-6">
								<div class="form-group label-floating" style="margin:20px 0">
									...
									<input class="form-control" type="password" required="" id="confirmPassword" name="confirmPassword">
								</div>
							</div>
						</div>
